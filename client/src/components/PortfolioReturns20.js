...
function PortfolioReturns20({ selectedWeights, onWeightChange, weightConfigs }) {
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.oneYear || 0}/20</td>
              </tr>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.twoYear || 0}/20</td>
              </tr>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.threeYear || 0}/20</td>
              </tr>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.fourYear || 0}/20</td>
              </tr>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.fiveYear || 0}/20</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default PortfolioReturns20;
