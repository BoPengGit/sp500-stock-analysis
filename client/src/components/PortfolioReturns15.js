...
function PortfolioReturns15({ selectedWeights, onWeightChange, weightConfigs }) {
    ...
    return (
      <div className="portfolio-returns">
        <h2 onClick={() => setIsCollapsed(!isCollapsed)} style={{cursor: 'pointer'}}>
          {isCollapsed ? '▶' : '▼'} Equal-Weighted Portfolio Returns (Top 15 Stocks)
        </h2>
    ...
    <div className="portfolio-returns">
      <div className="returns-header">
        ...
        {!isCollapsed && (
          ...
          Top 15 stocks with 6.67% allocation each
        </p>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.oneYear || 0}/15</td>
              </tr>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.twoYear || 0}/15</td>
              </tr>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.threeYear || 0}/15</td>
              </tr>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.fourYear || 0}/15</td>
              </tr>
              <tr>
                ...
                <td className="valid-stocks">{returns.portfolio.validStocks?.fiveYear || 0}/15</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default PortfolioReturns15;
